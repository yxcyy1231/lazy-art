            ...
            <div className="mt-6 space-y-5 text-slate-700">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p>週三 18:30－20:00</p>
                  <p>週四 16:30－18:00</p>
                  <p>週六 10:30－12:00 | 15:10－16:40</p>
                  <p>週日 09:00－10:30 | 15:10－16:40</p>
                </div>
              </div>
          ...
          <div className="mt-8 rounded-3xl bg-white p-8 shadow-lg">
            ...
            <div className="mt-6 divide-y divide-[#EFE5DE]">
              ...
              <div className="flex items-center justify-between py-4">
                ...
                <p className="text-xl font-black text-[#8B1E2D]">NT$750</p>
              </div>

              <div className="py-4">
                <div className="flex items-center justify-between">
                  <p className="font-bold text-slate-900">12 堂方案</p>
                  <p className="text-xl font-black text-[#8B1E2D]">NT$8,250</p>
                </div>
              ...
              <div className="py-4">
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-xl font-black text-[#8B1E2D]">NT$12,000</p>
                </div>
